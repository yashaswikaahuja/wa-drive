#!/usr/bin/env node
/**
 * Unit tests for apps/extension/perception/canonical-hash.js
 */
...
const { canonicalize, computeCanonicalHash, VOLATILE_FIELDS } = require(resolve(ROOT, 'apps/extension/perception/canonical-hash.js'));
