...
const { CcFieldAliases }      = load('src/field-aliases.js');
const { CcFieldIdent }        = load('src/field-ident.js');
const { CcResolveChoice }     = load('src/resolve-choice.js');
const { CcDecideConditional } = load('src/decide-conditional.js');
