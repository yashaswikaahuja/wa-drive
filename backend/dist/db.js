 ...
 */
export async function findOrCreateCustomer(waId) {
 ...
 */
export async function saveWhatsAppFile(customerId, customerName, fileName, fileUrl, filePath) {
    const fileRecord = {
        id: uuidv4(),
        customerId,
        customerName,
 ...
 */
export async function getWhatsAppFiles(type) {
    if (type) {
