...
start "WA - GCP#2 whatsapp-service" cmd /k "gcloud compute ssh cybercontrol-whatsapp --zone=asia-south1-a --command=\"pm2 logs whatsapp-service --raw\""
timeout /t 1 /nobreak >nul
start "RESOLVER - GCP#2 whatsapp-resolver" cmd /k "gcloud compute ssh cybercontrol-whatsapp --zone=asia-south1-a --command=\"pm2 logs whatsapp-resolver --raw\""
